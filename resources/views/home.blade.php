...
<div id="hero"
     ...
     data-images='[
         ...
         "{{ asset('Archive/WhatsApp Image 2025-05-10 at 10.22.47 AM.jpeg') }}",
         "{{ asset('Archive/image2.JPG') }}", 
         "{{ asset('Archive/gen1.jpeg') }}",
          "{{ asset('Archive/image3.JPG') }}",
             "{{ asset('Archive/image6.JPG') }}",
              "{{ asset('Archive/image7.jpeg') }}"
     ]'
     data-headlines='[
...
<section id="services" class="py-16 bg-gray-50">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-800 mb-4"> Our team Professional Services</h2>
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-10 -z-1" 
                 style="background-image: url('{{ asset('Archive/gen1.jpeg') }}');"></div>
            
            <!-- Grid content -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
                <!-- Service 1 -->
                <div class="bg-white bg-opacity-90 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1">
